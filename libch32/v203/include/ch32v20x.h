/********************************** (C) COPYRIGHT
 ******************************** File Name          : ch32v20x.h Author : WCH
 * Version            : V1.0.0
 * Date               : 2024/01/31
...
#define HSE_VALUE \
  ((uint32_t)32000000) /* Value of the External oscillator in Hz */
#else
#define HSE_VALUE \
...
#define __CH32V20x_STDPERIPH_VERSION          \
  ((__CH32V20x_STDPERIPH_VERSION_MAIN << 8) | \
...
/* ETH register */
#define R8_ETH_EIE \
  (*((volatile uint8_t *)(0x40028000 + 3))) /* Interrupt Enable Register */
...
#define RB_ETH_EIE_R_EN50                                                                                      \
  0x04                         /* RW TX 50�� resistor adjustment. 1: On-chip 50�� connected 0: On-chip \
                                  50�� disconnected */
#define RB_ETH_EIE_TXERIE 0x02 /* RW Transmit Error Interrupt Enable */
#define RB_ETH_EIE_RXERIE 0x01 /* RW1 receive error flag */
#define R8_ETH_EIR \
  (*((volatile uint8_t *)(0x40028000 + 4))) /* Interrupt Flag Register */
...
#define R8_ETH_ESTAT \
  (*((volatile uint8_t *)(0x40028000 + 5))) /* status register */
...
#define R8_ETH_ECON2                   \
  (*((volatile uint8_t *)(0x40028000 + \
                          6))) /* ETH PHY Analog Block Control Register */
...
#define R8_ETH_ECON1 \
  (*((volatile uint8_t *)(0x40028000 + 7))) /* Transceiver Control Register */
#define RB_ETH_ECON1_TXRST 0x80             /* RW Send module reset */
#define RB_ETH_ECON1_RXRST 0x40             /* RW Receiver module reset */
#define RB_ETH_ECON1_TXRTS                                                  \
  0x08 /* RW The transmission starts, and it is automatically cleared after \
          the transmission is completed. */
#define RB_ETH_ECON1_RXEN                                                 \
  0x04 /* RW Receive is enabled, when cleared, the error flag RXERIF will \
          change to 1 if it is receiving */

#define R32_ETH_TX (*((volatile uint32_t *)(0x40028000 + 8))) /* send control \
                                                               */
#define R16_ETH_ETXST                   \
  (*((volatile uint16_t *)(0x40028000 + \
                           8))) /* RW Send DMA buffer start address */
#define R16_ETH_ETXLN \
  (*((volatile uint16_t *)(0x40028000 + 0xA))) /* RW send length */
#define R32_ETH_RX \
  (*((volatile uint32_t *)(0x40028000 + 0xC))) /* receive control */
#define R16_ETH_ERXST                   \
  (*((volatile uint16_t *)(0x40028000 + \
                           0xC))) /* RW Receive DMA buffer start address */
#define R16_ETH_ERXLN \
  (*((volatile uint16_t *)(0x40028000 + 0xE))) /* RO receive length */

#define R32_ETH_HTL (*((volatile uint32_t *)(0x40028000 + 0x10)))
#define R8_ETH_EHT0 \
  (*((volatile uint8_t *)(0x40028000 + 0x10))) /* RW Hash Table Byte0 */
#define R8_ETH_EHT1 \
  (*((volatile uint8_t *)(0x40028000 + 0x11))) /* RW Hash Table Byte1 */
#define R8_ETH_EHT2 \
  (*((volatile uint8_t *)(0x40028000 + 0x12))) /* RW Hash Table Byte2 */
#define R8_ETH_EHT3 \
  (*((volatile uint8_t *)(0x40028000 + 0x13))) /* RW Hash Table Byte3 */
#define R32_ETH_HTH (*((volatile uint32_t *)(0x40028000 + 0x14)))
#define R8_ETH_EHT4 \
  (*((volatile uint8_t *)(0x40028000 + 0x14))) /* RW Hash Table Byte4 */
#define R8_ETH_EHT5 \
  (*((volatile uint8_t *)(0x40028000 + 0x15))) /* RW Hash Table Byte5 */
#define R8_ETH_EHT6 \
  (*((volatile uint8_t *)(0x40028000 + 0x16))) /* RW Hash Table Byte6 */
#define R8_ETH_EHT7 \
  (*((volatile uint8_t *)(0x40028000 + 0x17))) /* RW Hash Table Byte7 */

#define R32_ETH_MACON (*((volatile uint32_t *)(0x40028000 + 0x18)))
#define R8_ETH_ERXFCON                                                      \
  (*((volatile uint8_t *)(0x40028000 + 0x18))) /* Received Packet Filtering \
                                                  Control Register */
/* RW 0=Do not enable this filter condition, 1=When ANDOR=1,
target address mismatch will be filtered, when ANDOR=0, target address match
will be accepted */
...
#define R8_ETH_MACON1                                                        \
  (*((volatile uint8_t *)(0x40028000 + 0x19))) /* Mac flow control registers \
                                                */
/* RW When FULDPX=0 is invalid, when FULDPX=1, 11=send 0 timer pause frame,
then stop sending, 10=send pause frame periodically, 01=send pause frame once,
then stop sending, 00=stop sending pause frame */
...
#define RB_ETH_MACON1_PASSALL                                           \
  0x02 /* RW 1=Unfiltered control frames will be written to the buffer, \
          0=Control frames will be filtered */
#define RB_ETH_MACON1_MARXEN 0x01 /* RW MAC layer receive enable */
#define R8_ETH_MACON2                  \
  (*((volatile uint8_t *)(0x40028000 + \
                          0x1A))) /* Mac Layer Packet Control Register */
#define RB_ETH_MACON2_PADCFG 0xE0 /* RW Short Packet Padding Settings */
#define RB_ETH_MACON2_TXCRCEN                                                 \
  0x10 /* RW Send to add crc, if you need to add crc in PADCFG, this position \
          is 1 */
#define RB_ETH_MACON2_PHDREN \
  0x08 /* RW Special 4 bytes do not participate in crc check */
#define RB_ETH_MACON2_HFRMEN 0x04 /* RW Allow jumbo frames */
#define RB_ETH_MACON2_FULDPX 0x01 /* RW full duplex */
#define R8_ETH_MABBIPG                 \
  (*((volatile uint8_t *)(0x40028000 + \
                          0x1B))) /* Minimum Interpacket Interval Register */
#define RB_ETH_MABBIPG_MABBIPG \
  0x7F /* RW Minimum number of bytes between packets */

#define R32_ETH_TIM (*((volatile uint32_t *)(0x40028000 + 0x1C)))
#define R16_ETH_EPAUS                                                          \
  (*((volatile uint16_t *)(0x40028000 + 0x1C))) /* RW Flow Control Pause Frame \
                                                   Time Register */
#define R16_ETH_MAMXFL                                                        \
  (*((volatile uint16_t *)(0x40028000 + 0x1E))) /* RW Maximum Received Packet \
                                                   Length Register */
#define R16_ETH_MIRD                                                         \
  (*((volatile uint16_t *)(0x40028000 + 0x20))) /* RW MII read data register \
                                                 */

#define R32_ETH_MIWR (*((volatile uint32_t *)(0x40028000 + 0x24)))
#define R8_ETH_MIREGADR \
  (*((volatile uint8_t *)(0x40028000 + 0x24))) /* MII address register*/
#define RB_ETH_MIREGADR_MASK 0x1F /* RW PHY register address mask */
#define R8_ETH_MISTAT                  \
  (*((volatile uint8_t *)(0x40028000 + \
                          0x25))) /* RW PHY register address mask */
// #define  RB_ETH_MIREGADR_MIIWR  0x20                  /* WO MII write command
// */
#define R16_ETH_MIWR                                                          \
  (*((volatile uint16_t *)(0x40028000 + 0x26))) /* WO MII Write Data Register \
                                                 */
#define R32_ETH_MAADRL \
  (*((volatile uint32_t *)(0x40028000 + 0x28))) /* RW MAC 1-4 */
#define R8_ETH_MAADRL1 \
  (*((volatile uint8_t *)(0x40028000 + 0x28))) /* RW MAC 1 */
#define R8_ETH_MAADRL2 \
  (*((volatile uint8_t *)(0x40028000 + 0x29))) /* RW MAC 2 */
#define R8_ETH_MAADRL3 \
  (*((volatile uint8_t *)(0x40028000 + 0x2A))) /* RW MAC 3 */
#define R8_ETH_MAADRL4 \
  (*((volatile uint8_t *)(0x40028000 + 0x2B))) /* RW MAC 4 */
#define R16_ETH_MAADRH \
  (*((volatile uint16_t *)(0x40028000 + 0x2C))) /* RW MAC 5-6 */
#define R8_ETH_MAADRL5 \
  (*((volatile uint8_t *)(0x40028000 + 0x2C))) /* RW MAC 4 */
#define R8_ETH_MAADRL6 \
  (*((volatile uint8_t *)(0x40028000 + 0x2D))) /* RW MAC 4 */
...
#define FCEN_0_TIMER \
  (3 << 4)                  /* Send a 0 timer pause frame, then stop sending */
...
#define PADCFG_AUTO_0                                                         \
  (7 << 5) /* All short packets are filled with 00h to 64 bytes, then 4 bytes \
              crc */
...
with 00h to 64 bytes, otherwise the short packet is filled with 60 bytes of 0,
and then 4 bytes of crc after filling */
#define PADCFG_DETE_AUTO (5 << 5)
#define PADCFG_NO_ACT_1 (4 << 5) /* No padding for short packets */
#define PADCFG_AUTO_1                                                         \
  (3 << 5) /* All short packets are filled with 00h to 64 bytes, then 4 bytes \
              crc */
#define PADCFG_NO_ACT_2 (2 << 5) /* No padding for short packets */
#define PADCFG_AUTO_3                                                       \
  (1 << 5) /* All short packets are filled with 00h to 60 bytes, and then 4 \
              bytes crc */
