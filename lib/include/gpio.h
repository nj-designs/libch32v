...
enum GPIOPinId {
  ...
  PIN_PA8 = CREATE_PIN_NUMBER(GPIO_A_IDX, 8),
...
enum GPIOPinId {
  ...
  PIN_PB10 = CREATE_PIN_NUMBER(GPIO_B_IDX, 10),
  PIN_PB11 = CREATE_PIN_NUMBER(GPIO_B_IDX, 11),
  PIN_PB12 = CREATE_PIN_NUMBER(GPIO_B_IDX, 12),
  PIN_PB13 = CREATE_PIN_NUMBER(GPIO_B_IDX, 13),
  PIN_PB14 = CREATE_PIN_NUMBER(GPIO_B_IDX, 14),
  PIN_PB15 = CREATE_PIN_NUMBER(GPIO_B_IDX, 15),
