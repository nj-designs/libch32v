...
static volatile uint32_t *const peripheral_reset_reg_look_up[] = {&rcc.ahbrstr, &rcc.apb1prstr,
                                                                  &rcc.apb2prstr};
...
static const struct RCCCfgValues cfg_table[] = {
    {.hse_freq = 8'000'000,
     .sysclk_freq = 128'000'000,
     .hclk_freq = 128'000'000,  // RCC_CFGR0_HPRE_DIV_1
     .usbclk_freq = 48'000'000, // RCC_CFGR0_USBPRE_DIV_3 TODO(njohn): This is wrong!!
     .pclk1_freq = 32'000'000,  // RCC_CFGR0_PPRE1_DIV_4
     .pclk2_freq = 128'000'000, // RCC_CFGR0_PPRE2_DIV_1
     .adcclk_freq = 64'000'000, // RCC_CFGR0_ADCPRE_DIV_2
     .cfgr0 = RCC_CFGR0_MCO_NO_CLK | RCC_CFGR0_USBPRE_DIV_3 | RCC_CFGR0_PLLMUL_MUL_16 | RCC_CFGR0_PLLSRC |
...
void rcc_init(void) {
  ...
  rcc.cfgr0 &=
      (uint32_t)~(RCC_CFGR0_MCO_MASK | RCC_CFGR0_ADCPRE_MASK | RCC_CFGR0_PPRE2_MASK | RCC_CFGR0_PPRE1_MASK |
  ...
  rcc.cfgr0 &=
      (uint32_t)~(RCC_CFGR0_USBPRE_MASK | RCC_CFGR0_PLLMUL_MASK | RCC_CFGR0_PLLXTPRE | RCC_CFGR0_PLLSRC);

  rcc.intr = RCC_INTR_CSSC | RCC_INTR_PLLRDYC | RCC_INTR_HSERDYC | RCC_INTR_HSIRDYC | RCC_INTR_LSERDYC |
             RCC_INTR_LSIRDYC;
