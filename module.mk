...
LDFLAGS += -Wl,-Map,$(BUILD)/$(APP_NAME).map -nostdlib -nodefaultlibs -nolibc -nostartfiles
...
lst: $(BUILD)/$(APP_NAME).lst
sym: $(BUILD)/$(APP_NAME).sym
bin: $(BUILD)/$(APP_NAME).bin
hex: $(BUILD)/$(APP_NAME).hex
